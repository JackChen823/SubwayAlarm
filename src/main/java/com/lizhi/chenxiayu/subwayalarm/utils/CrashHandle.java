...
/**
 * Created by chenxiayu on 2017/6/5.
 */
...
//        String fileName = "partylive-" + time + ".log";
            ...
            if (hasSdcard()) {
                ...
                Log.i("chenxiayu","fileName:-path-"+path);
                if (!dir.exists())
                    dir.mkdirs();
                Log.i("chenxiayu","fileName:-path+name11-"+path + fileName);
                try {
                    fos = new FileOutputStream(path + fileName, true);
                    Log.i("chenxiayu","sb--22-");
                    fos.write(sb.getBytes());
                    fos.flush();
                }catch (Exception e){
                    Log.i("chenxiayu","sb--11-"+sb);
                }finally {
                    fos.close();
                }
        ...
        public static String getGlobalpath() {
            return Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator + "partylive" + File.separator;
